...
values (
	'1000', '400', '200', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP() + 200, 'Emergency, Large, 100'
);
insert into DEQUEUED_AIRCRAFT (
	ID, AIRCRAFT_TYPE_ID, AIRCRAFT_SIZE_ID, ENQUEUED_TIMESTAMP, DEQUEUED_TIMESTAMP, AIRCRAFT_NAME
)
values (
	'2000', '400', '100', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP() + 200, 'Emergency, Small, 200'
);
...
values (
	'3000', '300', '200', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP() + 300, 'VIP Large 300'
);
insert into DEQUEUED_AIRCRAFT (
	ID, AIRCRAFT_TYPE_ID, AIRCRAFT_SIZE_ID, ENQUEUED_TIMESTAMP, DEQUEUED_TIMESTAMP, AIRCRAFT_NAME
)
values (
	'4000', '300', '100', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP() + 400, 'VIP Small 400'
);
...
values (
	'5000', '200', '200', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP() + 500, 'Passenger Large 500'
);
insert into DEQUEUED_AIRCRAFT (
	ID, AIRCRAFT_TYPE_ID, AIRCRAFT_SIZE_ID, ENQUEUED_TIMESTAMP, DEQUEUED_TIMESTAMP, AIRCRAFT_NAME
)
values (
	'6000', '200', '100', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP() + 600, 'Passenger Small 600'
);
...
values (
	'7000', '100', '200', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP() + 700, 'Cargo Large 700'
);
insert into DEQUEUED_AIRCRAFT (
	ID, AIRCRAFT_TYPE_ID, AIRCRAFT_SIZE_ID, ENQUEUED_TIMESTAMP, DEQUEUED_TIMESTAMP, AIRCRAFT_NAME
)
values (
	'8000', '100', '100', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP() + 800, 'Cargo Small 800'
);
